        ...
        <div class="container mx-auto py-8">
            <div class="card-con flex flex-col lg:flex-row bg-white rounded-lg shadow-lg overflow-hidden">
                ...
                <div class="card-show w-full lg:w-1/2 p-8">
                    <div class="info">
                        <h1 class="text-4xl font-extrabold text-gray-600 mb-2">Owner: {{ pet.user.name }}</h1>
                        <h3 class="text-lg font-medium text-gray-500 mb-4">Email: {{ pet.user.email }}</h3>
                        <p class="text-sm text-gray-500 mb-6">{{ formatDate(pet.created_at) }}</p>

                        <h2 class="text-3xl font-semibold text-teal-600 mb-4">About Me</h2>
                        ...
                        <p class="text-gray-700 mb-4">Description: {{ pet.description }}</p>

                        <p class="text-lg font-semibold text-gray-800 mb-4">If you see me, please contact:</p>
                        <p class="text-2xl font-bold text-teal-700">{{ pet.phone_number }}</p>
                    </div>
                </div>
            </div>
        </div>
